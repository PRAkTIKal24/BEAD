#!/bin/bash
#$ -N bead_transformer_vae
#$ -pe smp 4
#$ -l mem=16G
#$ -l h_rt=48:00:00
#$ -j y
#$ -o bead_transformer_vae.log
...
PROJECT_NAME="TransformerVAE_500epochs"
...
# Modify config file to set model and training parameters
...
sed -i 's/c.model_name                   = "ConvVAE"/c.model_name                   = "TransformerVAE"/' $CONFIG_FILE
